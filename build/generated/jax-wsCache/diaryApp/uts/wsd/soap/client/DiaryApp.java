 ...
 * 
 */
@WebServiceClient(name = "diaryApp", targetNamespace = "http://soap.wsd.uts/", wsdlLocation = "http://localhost:8080/labs/diaryApp?wsdl")
    ...
    extends Service
{
    ...
    static {
        ...
        try {
            url = new URL("http://localhost:8080/labs/diaryApp?wsdl");

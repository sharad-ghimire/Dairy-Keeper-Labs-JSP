 ...
 * 
 */
@WebServiceClient(name = "Calculator", targetNamespace = "http://soap.wsd.uts/", wsdlLocation = "http://localhost:8080/labs/Calculator?wsdl")
    ...
    extends Service
{
    ...
    private final static QName CALCULATOR_QNAME = new QName("http://soap.wsd.uts/", "Calculator");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:8080/labs/Calculator?wsdl");
    ...
    public Calculator getCalculatorPort() {
        return super.getPort(new QName("http://soap.wsd.uts/", "CalculatorPort"), Calculator.class);
    }
    ...
    public Calculator getCalculatorPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://soap.wsd.uts/", "CalculatorPort"), Calculator.class, features);
    }
